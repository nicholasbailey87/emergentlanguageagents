...
# TODO: make receivers initialise submodules based on config strings as in receivers.py
...
class Listener(CopyListener):
    def __init__(
        ...
        **kwargs
        ...
        self.embedding = embedding_module # TODO: make receiver instantiate its own embedding model like nn.Embedding(args.vocab_size + 3, args.embedding_size)
